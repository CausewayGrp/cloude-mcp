// CauseWay HQ — declarative list schema (CW-PROMPT-SP-001 v2.0, §5–§9).
//
// Every column, choice, competency, grade and account class below is taken
// verbatim from the build spec — nothing here is invented business content.
// Where the spec defers a detail to the firm's workbook or to a v1.0 list that
// this document does not fully reproduce, that is marked `pending:` and tracked
// in docs/PENDING.md rather than guessed.
